...
public class Lesson {
    ...
    private static void getReports(ArrayList<ReportRecord> records) throws ParseException {
        LinkedHashMap<String, Double> allEexpenses = new LinkedHashMap<>();
        ...
        for (ReportRecord record : records) {
            ...
            allEexpenses.put(record.getShop(), allEexpenses.getOrDefault(record.getShop(), (double) 0) + record.getOutcome());
        }
        ...
        System.out.println();
        for (Map.Entry<String, Double> entry : allEexpenses.entrySet()) {
